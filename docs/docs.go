    ...
    "definitions": {
        ...
        "apidocs.StatusData": {
            ...
            "properties": {
                ...
                "InstanceId": {
                    "description": "InstanceId is the canonical ID of the instance selected by the authenticated instance token.",
                    "type": "string",
                    "example": "d2b52b8b-64ce-4eae-a2bb-33a7fd6ae4ce"
                },
                "InstanceName": {
                    "description": "InstanceName is the configured administrative instance name. Legacy records without a name fall back to InstanceId.",
                    "type": "string",
                    "example": "Nibi EU"
                },
                "LoggedIn": {
                ...
                "Name": {
                    "description": "Name is the WhatsApp provider push name when the runtime is logged in. It is empty when no provider profile is available.",
                    "type": "string",
                    "example": "My WhatsApp"
                }
            }
