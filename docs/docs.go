...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apidocs.GroupListListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_groupList_handler.CreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/apidocs.GroupListDetailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_groupList_handler.UpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apidocs.GroupListAuditListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apidocs.GroupListEntryListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_group_service.GroupDirectorySummary"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_group_service.GroupMember"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/pkg_instance_handler.InstanceMetadataView"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "apidocs.GroupListAuditListResponse": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/apidocs.GroupListAuditEvent"
                    }
                },
                "message": {
                    "type": "string",
        ...
        "apidocs.GroupListDetailResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_groupList_repository.Summary"
                },
                "message": {
                    "type": "string",
                    "example": "success"
        ...
        "apidocs.GroupListEntryListResponse": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_groupList_service.EntryView"
                    }
                },
                "message": {
                    "type": "string",
        ...
        "github_com_evolution-foundation_evolution-go_pkg_group_service.GroupMember": {
            ...
            "properties": {
                "actions": {
                    "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_group_service.GroupMemberActions"
                },
                "displayName": {
                    "type": "string"
                },
        ...
        "pkg_groupList_handler.CreateRequest": {
            ...
            "properties": {
                "authorization": {
                    "$ref": "#/definitions/pkg_groupList_handler.AuthorizationRequest"
                },
                "description": {
                    "type": "string"
                },
