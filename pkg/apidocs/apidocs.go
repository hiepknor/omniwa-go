...
type CapabilitiesData struct {
	...
	Capabilities    []string `json:"capabilities" example:"campaign_orchestration,rate_limit_retry_after,groups_projection,contacts_projection,chats_projection,canonical_contact_identity,group_lists,group_list_eligibility,campaign_group_targets,campaign_image_content,instance_metadata_views,instance_credential_health,instance_token_rotation"`
